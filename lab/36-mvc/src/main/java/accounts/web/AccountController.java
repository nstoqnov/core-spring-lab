 ...
 *
 */
// DoneTODO-03: Add an appropriate annotation to make this class a REST controller
@RestController
public class AccountController {
	 ...
	 */
	// DoneTODO-04: Add an appropriate annotation to make this method handle "/accounts"
	@GetMapping("/accounts")
	public List<Account> accountList() {

		// DoneTODO-05: Implement the logic to find and return all accounts
		...
		return allAccounts; // REPLACE THIS LINE to return a list accounts
	...
	// DoneTODO-08: Implement the /accounts/{entityId} request handling method.
	...
	public Account getAccountById(@PathVariable Long entityId){
		Account account = accountManager.getAccount(entityId);
		return account;
	}

	// DoneTODO-10b: If AccountControllerTests.testHandleDetailsRequest()
	//  fails, fix errors before moving on

	// DoneTODO-11: Run the application
