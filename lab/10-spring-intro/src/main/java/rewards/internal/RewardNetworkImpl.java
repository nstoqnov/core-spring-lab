 ...
 *
 * DoneTODO-00: In this lab, you are going to exercise the following:
 ...
 *
 * DoneTODO-01: Review the Rewards Application document (Refer to the lab document)
 * DoneTODO-02: Review project dependencies (Refer to the lab document)
 * DoneTODO-03: Review Rewards Commons project (Refer to the lab document)
 * DoneTODO-04: Review RewardNetwork interface and RewardNetworkImpl class below
 * DoneTODO-05: Review the RewardNetworkImpl configuration logic (Refer to the lab document)
 * DoneTODO-06: Review sequence diagram (Refer to the lab document)
 */
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		// DoneTODO-07: Write code here for rewarding an account according to
		//          the sequence diagram in the lab document
		// DoneTODO-08: Return the corresponding reward confirmation
