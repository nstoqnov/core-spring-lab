 ...
 *
 * DoneTODO-01: Make this class a Spring configuration class
 * - Use an appropriate annotation.
 *
 * DoneTODO-02: Define four empty @Bean methods, one for the
 ...
 *   - rewardRepository
 *
 * DoneTODO-03: Inject DataSource through constructor injection
 ...
 *
 * DoneTODO-04: Implement each @Bean method to contain the code
